...
class SVM_PREDICTION():
  ...
  def fit(self,x,y,list_of_labels,test_train_split,validations,learning_rate,iteration):
    ...
    for each_iter in range(validations):
      ...
      print("recall: ",recall)#tn, fp, fn, tp = confusion_matrix(y_test, y_pred)
      print("Validation",each_iter+1,"accuracy score: ",list_of_accuracies[each_iter])#confusionMatrix = [tn,fp,fn,tp]
